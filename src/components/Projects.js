...
const Projects = () => {
  const allProjects = [
    {
      ...
      description:
        "Created a super fast voice-activated personal assistant by utilizing a Groq AI API. This assistant is capable of receiving voice messages and providing vocal responses with a avg latency of 1.2sec.",
    ...
    },
    {
      ...
      description:
        "Developed a Copilot tool for software architects using RAG to deliver accurate architectural advice, leveraging a manually verified database of 5000+ ADRs.",
    ...
    },
    {
      ...
      description:
        "Designed and implemented a Dockerized Reddit-style social networking site, including user authentication, authorization, registration, chat box, followers, moderators, pages, create, save, and report posts, and many other features completed with testing.",
    ...
    },
    {
      ...
      description:
        "Developed 10+ machine learning models from scratch, including KNN, decision trees, PCA, CNN, Ensemble Learning, and HMM, optimizing performance with hyperparameter tuning via Wandb.",
    ...
    },
    {
      ...
      description:
        "A Linux-like shell from scratch using modular C code with a 3000+ line codebase, supporting: I/O redirection, piping, background/foreground processes, signals, and a custom discover feature.",
    ...
    },
    {
      ...
      description:
        "Using AI to dynamically control the number of instances (servers) of a project on AWS cloud to balance the incoming load by recognizing hand gestures using pre-trained models.",
    ...
    },
    {
      ...
      description:
        "Developed a CLI using pymysql library to connect Python with MySQL database on localhost, providing a user-friendly and abstracted interface for executing queries over fictitious University data.",
    ...
    },
    {
      ...
      description:
        "Collaborated to develop an embedded system project that tracks data on volume, usage, and waste while monitoring water flow in pipes. Had a web interface that used graphics to present the data.",
    ...
    },
    {
      ...
      description:
        "Collaborated to develop a prototype of a room equipped with a smart fan, smart light, and motion detection controlled by sensors for optimal energy use.",
  ...
  const container = {
    ...
    show: {
      opacity: 1,
      transition: { staggerChildren: 0.15 }, // Increased stagger for more visible effect
    },
  };
  ...
  return (
    <section id="projects" className="projects py-20 relative">
      {/* Cosmic nebula effect for background */}
      <div className="cosmic-nebula"></div>

      <div className="container relative z-10">
        <ScrollAnimation type="cosmic">
          <h2 className="section-title text-center mb-6 text-accent font-bold text-3xl">
            Creative Builds
            ...
            <button
              ...
              className={`px-4 py-2 rounded-full font-medium transition-all duration-300 ${
                activeCategory === category 
                  ...
                  : 'bg-light-gray hover:bg-secondary/50 text-secondary hover:text-primary border border-white'
              }`}
            >
              {category}
            </button>
        ...
        >
          {currentProjects.map((project, index) => (
            ...
            >
              <motion.div
                className="project-card relative overflow-hidden rounded-lg cosmic-card shadow-cosmic"
                whileHover={{
                  y: -10,
                  boxShadow: "0 10px 30px -10px rgba(109, 138, 255, 0.4)",
              ...
              >
                <div className="project-image">
                  <img
                    ...
                    alt={project.title}
                  />
                  <div className="cosmic-image-overlay"></div>
                </div>
                <div className="project-info">
                  ...
                  <div className="project-tags cosmic-tags">
                ...
                {hoveredProject === index && (
                  <div className="absolute inset-0 bg-black/90 p-6 flex flex-col justify-center text-white rounded-custom transition-all duration-300">
                    ...
                    <div className="project-tags mb-4">
                      {project.technologies.map((tech, i) => (
                        <span key={i} className="bg-primary/80 text-white">
                          {tech}
                        </span>
                      ))}
                    </div>
            ...
            <div className="flex justify-center mt-8 gap-2">
              {Array.from({ length: totalPages }, (_, i) => (
                <motion.button
                  ...
                  whileHover={{
                    scale: 1.1,
                    boxShadow: "0 0 10px rgba(109, 138, 255, 0.3)",
                  }}
                  whileTap={{ scale: 0.95 }}
                >
                  {i + 1}
